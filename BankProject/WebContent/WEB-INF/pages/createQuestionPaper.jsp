...
<meta charset="utf-8">
<title>Create Question Paper -        Online Exam To Evaluate Knowledge</title>
...
<script type="text/javascript">
	...
	function showDialog() {
		...
		if (testname == 0 || testname == null) {
			...
			var strHtml = "<table>"
			strHtml += "<tr><td>Category:</td><td><select id='subjectname' onchange='getTopic()' style='width: 223px;'><option value='0'>Select Category:</option><option value='5136' >Aptitude Questions (31)</option></select><span class='mandatory'>*</span></td></tr>";
			strHtml += "<tr><td>Sub Category:</td><td><div id='topicCont'><select id='subsubjectname' style='width: 223px;'><option>Select Sub Category</option><option value='2146' >General Questions (31)</option></select></div><div id='availableQuestions'></div></td></tr>";
			strHtml += "<tr><td>Complexity:</td><td><div id='complexity'><select name='levelid' id='testlevel' style='width: 223px;'><option value='0'>Select Complexity</option><option value='4585'>Beginners  (31)</option></select></div></td></tr>";
